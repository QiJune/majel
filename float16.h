...
__host__ __device__
inline
int to_int(const float16& t) {
    return t.to_int();
}

__host__ __device__
inline
int to_int(const float& t) {
    return static_cast<int>(t);
}

__host__ __device__
inline
int to_int(const double& t) {
    return static_cast<int>(t);
}

__host__ __device__
inline
float to_float(const float16& t) {
    return t.to_float();
}

__host__ __device__
inline
float to_float(const float& t) {
    return t;
}

__host__ __device__
inline
float to_float(const double& t) {
